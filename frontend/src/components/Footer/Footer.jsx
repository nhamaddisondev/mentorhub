        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <p className="mt-3 text-sm leading-6 text-gray-300">
              KhMentor helps learners and teams master modern web development with practical guides,
              mentorship, and real-world projects focused on React, Vue, Django, and deployment workflows.
            </p>
            <p className="mt-2 text-sm text-gray-400">
              Learn faster with hands-on examples, step-by-step roadmaps, and tool comparisons tailored for today’s stacks.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-3 text-sm text-gray-300">
              Get tips on React, Vue, Django, DevOps, and deployment best practices.
            </p>
            <form
            ...
            <p className="mt-3 text-xs text-gray-400">
              By subscribing, consent is given to receive updates. Unsubscribe any time.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <ul className="flex items-center gap-6 text-sm text-gray-400">
            <li>
              <a href="#" className="hover:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded">
                Terms
              </a>
            </li>
            <li>
